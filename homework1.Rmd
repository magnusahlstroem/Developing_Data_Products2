...
---
# This webpage was created `r strftime(as.Date("2018-08-02"), format = "%d %b %Y")` 
Search the map to find your favorite university and see how many articles they published between July 1, 2018 - July 31, 2018, there is also a link to 5 most recently accepted publications
...
#save(parsed, file = "C:/Users/mras0142/Documents/GitHub/DDP_Data/Parsed_medline_records.Rdata")
...
###Data on coordinates extracted with the ggmap package
